            ...
            <div className="cardsWrap flex flex-wrap w-[calc(100%+20px)] ml-[-10px] max-md:w-[calc(100%+20px)] max-md:ml-[-10px] max-sm:w-full max-sm:ml-0" data-aos="fade-up">
                {
                    courses?.course?.map((item, index) => {
                        return (
                              <div key={index} className="card w-[calc(33.33%-20px)] mx-[10px] rounded-[5px] border-black border-[2px] border-solid max-md:w-[calc(50%-20px)] max-md:mx-[10px] max-md:last:mt-[20px] max-sm:w-full max-sm:mx-0 max-sm:mb-[20px] max-sm:last:mt-0">
